 ...
 */
final class Version20240110134638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bike (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, color_id INT DEFAULT NULL, size_id INT DEFAULT NULL, image_id INT DEFAULT NULL, reference_bike VARCHAR(255) NOT NULL, name_bike VARCHAR(100) NOT NULL, description_bike LONGTEXT DEFAULT NULL, price_bike VARCHAR(100) DEFAULT NULL, INDEX IDX_4CBC378012469DE2 (category_id), INDEX IDX_4CBC37807ADA1FB5 (color_id), INDEX IDX_4CBC3780498DA827 (size_id), INDEX IDX_4CBC37803DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
